                    ...
                    <div class="feedback-modal">
                        <div class="modal-header">
                            <div style="display: flex; gap:10px;align-items: center;">
                                ...
                                <h3><?php echo esc_html__( 'Quick Feedback', 'multi-location-product-and-inventory-management-pro' ); ?></h3>
                            </div>
                        ...
                        <div class="modal-body">
                            <p>
                                ...
                                echo sprintf(
                                    ...
                                    esc_html__(
                                        'If you have a moment, please share why you are deactivating %s:',
                            ...
                            <form id="mulopimfwc_deactivation-feedback-form">
                                <div class="feedback-options">
                                    <label class="feedback-option">
                                        ...
                                        <?php echo esc_html__( "It's a temporary deactivation.", 'multi-location-product-and-inventory-management-pro' ); ?>
                                    </label>
                                    <label class="feedback-option">
                                        <input type="radio" name="reason" value="not-working">
                                        <span class="radio-button"></span>
                                        <?php echo esc_html__( "The plugin isn't working properly.", 'multi-location-product-and-inventory-management-pro' ); ?>
                                    </label>
                                    <label class="feedback-option">
                                        <input type="radio" name="reason" value="better-plugin">
                                        <span class="radio-button"></span>
                                        <?php echo esc_html__( "I found a better alternative plugin.", 'multi-location-product-and-inventory-management-pro' ); ?>
                                    </label>
                                    <label class="feedback-option">
                                        <input type="radio" name="reason" value="missing-feature">
                                        <span class="radio-button"></span>
                                        <?php echo esc_html__( "It's missing a specific feature.", 'multi-location-product-and-inventory-management-pro' ); ?>
                                    </label>
                                    <label class="feedback-option">
                                        <input type="radio" name="reason" value="other">
                                        <span class="radio-button"></span>
                                        <?php echo esc_html__( "Other", 'multi-location-product-and-inventory-management-pro' ); ?>
                                    </label>
                                </div>
                                <div class="other-reason-container" style="display:none;">
                                    <textarea
                                        name="other_reason"
                                        placeholder="<?php echo esc_attr__( 'Please tell us more...', 'multi-location-product-and-inventory-management-pro' ); ?>"
                                        rows="3"
                                    ></textarea>
                                </div>
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-primary">
                                        <?php echo esc_html__( 'Submit & Deactivate', 'multi-location-product-and-inventory-management-pro' ); ?>
                                    </button>
                                </div>
                            </form>
                        </div>
