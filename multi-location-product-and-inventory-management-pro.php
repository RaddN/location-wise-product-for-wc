...
if (!defined('mulopimfwc_VERSION')) {
    define("mulopimfwc_VERSION", "1.1.7.11");
}
...
?>
    ...
    <?php
        ...
        private function geocode_address(string $address, string $country = ''): array
        {
            ...
            $user_agent = sprintf('MulopimFWC/%s (%s)', defined('mulopimfwc_VERSION') ? mulopimfwc_VERSION : '1.1.7.11', home_url('/'));
        ...
        public function enqueue_scripts()
        {
            ...
            wp_enqueue_style('mulopimfwc_style', plugins_url('assets/css/style.css', __FILE__), [], '1.1.7.11');
            ...
            wp_enqueue_script('mulopimfwc_script', plugins_url('assets/js/script.js', __FILE__), ['jquery'], '1.1.7.11', true);
        ...
        {
            wp_enqueue_style('mulopimfwc-custom-admin-style', plugin_dir_url(__FILE__) . 'assets/css/admin-style.css', array(), "1.1.7.11");
        }
...
function mulopimfwc_check_for_plugin_updates($transient, $license_manager)
{
    ...
    $current_version = defined('mulopimfwc_VERSION') ? mulopimfwc_VERSION : '1.1.7.11';
