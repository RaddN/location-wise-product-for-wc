...
if (!defined('mulopimfwc_VERSION')) {
    define("mulopimfwc_VERSION", "1.1.4.16");
}
...
?>
    ...
    <?php
        ...
        public function enqueue_scripts()
        {
            ...
            wp_enqueue_style('mulopimfwc_style', plugins_url('assets/css/style.css', __FILE__), [], '1.1.4.16');
            ...
            wp_enqueue_script('mulopimfwc_script', plugins_url('assets/js/script.js', __FILE__), ['jquery'], '1.1.4.16', true);
        ...
        {
            wp_enqueue_style('mulopimfwc-custom-admin-style', plugin_dir_url(__FILE__) . 'assets/css/admin-style.css', array(), "1.1.4.16");
        }
