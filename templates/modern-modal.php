...
?>
<div id="lwp-store-selector-modal" class="lwp-modern-popup" style="display: <?php echo $show_modal ? 'flex' : 'none'; ?>;">
    <div class="lwp-modern-popup__panel">
        <div class="lwp-modern-popup__hero">
            ...
            <div class="lwp-modern-popup__heading">
                ...
                <?php } ?>
                <p class="lwp-modern-popup__subtitle"><?php esc_html_e('Find the closest store and start shopping with accurate local stock.', 'multi-location-product-and-inventory-management'); ?></p>
            </div>
        </div>
