...
class MULOPIMFWC_Dashboard
{
    ...
    public function enqueue_dashboard_assets($hook = '')
    {
        ...
        $dashboard_js_version = file_exists($dashboard_js_path) ? (string) filemtime($dashboard_js_path) : '1.1.7.22';
        $dashboard_css_version = file_exists($dashboard_css_path) ? (string) filemtime($dashboard_css_path) : '1.1.7.22';
...
?>
            ...
            <body>
                ...
                <!-- Footer -->
                <div class="footer">
                    <h2><?php esc_html_e('End of Report', 'multi-location-product-and-inventory-management-pro'); ?></h2>

                    <p><?php esc_html_e('Thank you for using Multi Location Product & Inventory Management for WooCommerce Pro!', 'multi-location-product-and-inventory-management-pro'); ?></p>

                    <p><?php esc_html_e('Generated by Multi Location Product & Inventory Management for WooCommerce Pro', 'multi-location-product-and-inventory-management-pro'); ?></p>
                </div>
            </body>
