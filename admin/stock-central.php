...
class mulopimfwc_Stock_Central
{
    ...
    public function enqueue_assets($hook)
    {
        ...
        wp_enqueue_style(
            ...
            plugin_dir_url(__FILE__) . '../assets/css/stock-central.css',
            [],
            $version
        );

        wp_register_script(
            'mulopimfwc-stock-central-inline',
            false,
            array('jquery'),
            $version,
            true
        );
        wp_enqueue_script('mulopimfwc-stock-central-inline');
    }
...
?>
        ...
        <?php
        $stock_central_inline_script = ob_get_clean();
        wp_add_inline_script('mulopimfwc-stock-central-inline', $stock_central_inline_script, 'after');
        ?>
<?php
    }
}
