...
General Settings', 'multi-location-product-and-inventory-management'),
        ...
        add_settings_field(
            ...
            function () {
                ...
                $message = $this->append_manual_disabled_note(__("Enable or disable location-specific information management.", 'multi-location-product-and-inventory-management'));
...
Popup Settings', 'multi-location-product-and-inventory-management'),
  ...
  <path fill="#2563eb" d="M13 7.118v-.007a.275.275 0 0 0-.277-.27h-.072l-1.12-2.166a.28.28 0 0 0-.246-.148H9.373l.073-.579a.8.8 0 0 0-.202-.614.8.8 0 0 0-.59-.256H2.716a.293.293 0 0 0-.29.264l-.06.477H5.75c.22 0 .393.178.387.398a.41.41 0 0 1-.408.397H4.6v.002H1.29a.29.29 0 0 0-.29.281.27.27 0 0 0 .274.281h4.385a.41.41 0 0 1 .35.421.44.44 0 0 1-.433.426H2.552a.293.293 0 0 0-.291.284.275.275 0 0 0 .277.284h2.987a.41.41 0 0 1 .357.421.44.44 0 0 1-.438.426H1.73a.293.293 0 0 0-.292.285.275.275 0 0 0 .277.284h.248l-.097 1.017c-.02.231.05.45.201.615a.8.8 0 0 0 .591.255h.215a1.24 1.24 0 0 0 1.226 1.026c.618 0 1.147-.442 1.28-1.026h2.675a.9.9 0 0 0 .582-.218.8.8 0 0 0 .555.218h.044a1.24 1.24 0 0 0 1.226 1.026c.618 0 1.147-.442 1.28-1.026h.176c.46 0 .868-.374.91-.834L13 7.145v-.02zm-8.887 3.236a.69.69 0 0 1-.692-.71.734.734 0 0 1 .729-.71c.391 0 .702.318.691.71a.734.734 0 0 1-.728.71m6.362 0a.69.69 0 0 1-.692-.71.734.734 0 0 1 .729-.71c.391 0 .701.318.691.71a.734.734 0 0 1-.728.71m1.785-1.328a.34.34 0 0 1-.33.302h-.19a1.24 1.24 0 0 0-1.213-.962c-.596 0-1.109.41-1.264.962h-.059a.24.24 0 0 1-.181-.076.24.24 0 0 1-.06-.19l.358-3.967h.823l-.13 1.444c-.022.231.05.45.2.615s.36.255.592.255h1.6z"/>
        ...
        add_settings_field(
            ...
            <?php } ?>
            <p class="description"><?php echo esc_html($this->append_manual_disabled_note(__('Enable different shipping options based on product location.', 'multi-location-product-and-inventory-management'))); ?></p>
  ...
  <path fill="#2563eb" d="M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2m0 14H4v-6h16zm0-10H4V6h16z"/>
        ...
        add_settings_field(
            ...
            <?php } ?>
            <p class="description"><?php echo esc_html($this->append_manual_disabled_note(__('Enable or disable payment method restrictions by location.', 'multi-location-product-and-inventory-management'))); ?></p>
            <?php
                if (empty($payments)) {
                    echo '<div class="lwp-notice lwp-notice-warning" style="background-color: #fff3cd; border: 1px solid #ffeeba; border-left: 4px solid #ffc107; border-radius: 4px; padding: 12px 16px; margin: 10px 0;">
                            <div style="display: flex; align-items: start; gap: 12px;">
  ...
  <path fill="#2563eb" d="M829.44 911.36c45.245 0 81.92-36.675 81.92-81.92V194.56c0-45.245-36.675-81.92-81.92-81.92H194.56c-45.245 0-81.92 36.675-81.92 81.92v634.88c0 45.245 36.675 81.92 81.92 81.92zm0 40.96H194.56c-67.866 0-122.88-55.014-122.88-122.88V194.56c0-67.866 55.014-122.88 122.88-122.88h634.88c67.866 0 122.88 55.014 122.88 122.88v634.88c0 67.866-55.014 122.88-122.88 122.88"/>
        ...
        add_settings_field(
            ...
            <?php } ?>
            <p class="description"><?php echo esc_html($this->append_manual_disabled_note(__('Apply different tax rates based on the product location.', 'multi-location-product-and-inventory-management'))); ?></p>
            <?php
                if (!$wc_tax_enabled) {
                    echo '<div class="lwp-notice lwp-notice-warning" style="background-color: #fff3cd; border: 1px solid #ffeeba; border-left: 4px solid #ffc107; border-radius: 4px; padding: 12px 16px; margin: 10px 0;">
                        <div style="display: flex; align-items: start; gap: 12px;">
  ...
  <path fill="#2563eb" fill-rule="evenodd" d="M11.566.66a2.19 2.19 0 0 0-3.132 0l-.962.985a2.2 2.2 0 0 1-1.592.66l-1.377-.017a2.19 2.19 0 0 0-2.215 2.215l.016 1.377a2.2 2.2 0 0 1-.66 1.592l-.984.962a2.19 2.19 0 0 0 0 3.132l.985.962c.428.418.667.994.66 1.592l-.017 1.377a2.19 2.19 0 0 0 2.215 2.215l1.377-.016a2.2 2.2 0 0 1 1.592.66l.962.984c.859.88 2.273.88 3.132 0l.962-.985a2.2 2.2 0 0 1 1.592-.66l1.377.017a2.19 2.19 0 0 0 2.215-2.215l-.016-1.377a2.2 2.2 0 0 1 .66-1.592l.984-.962c.88-.859.88-2.273 0-3.132l-.985-.962a2.2 2.2 0 0 1-.66-1.592l.017-1.377a2.19 2.19 0 0 0-2.215-2.215l-1.377.016a2.2 2.2 0 0 1-1.592-.66zM7 8.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3m6 6a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3m.778-8.278a1.1 1.1 0 0 1 0 1.556l-6 6a1.1 1.1 0 1 1-1.556-1.556l6-6a1.1 1.1 0 0 1 1.556 0"/>
        ...
        add_settings_field(
            ...
            <?php } ?>
            <p class="description"><?php echo esc_html($this->append_manual_disabled_note(__('Allow different discount rules for each store location.', 'multi-location-product-and-inventory-management'))); ?></p>
  ...
  <path fill="#2563eb" d="m247.157 128.196-47.476-6.9-21.23-43.019a15 15 0 0 0-26.902 0l-21.23 43.019-47.476 6.9a14.998 14.998 0 0 0-8.312 25.585l34.353 33.486-8.109 47.282a15 15 0 0 0 21.765 15.813L165 228.039l42.462 22.323a15 15 0 0 0 6.979 1.723h.05c8.271-.015 14.972-6.725 14.972-15 0-1.152-.13-2.274-.375-3.352l-7.97-46.466 34.352-33.486a15 15 0 0 0-8.313-25.585"/>
        ...
        add_settings_field(
            ...
            <?php } ?>
            <p class="description"><?php echo esc_html($this->append_manual_disabled_note(__('Allow products to have different reviews based on location.', 'multi-location-product-and-inventory-management'))); ?></p>
            <?php
            },
            'lwp-location-reviews-settings',
            'mulopimfwc_reviews_section'
  ...
  <path fill="#9333ea" d="M24 16c-4.4 0-8 3.6-8 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8m3 9h-3c-.6 0-1-.4-1-1v-4c0-.6.4-1 1-1s1 .4 1 1v3h2c.6 0 1 .4 1 1s-.4 1-1 1M22.9 4.6c-.1-.4-.5-.6-.9-.6H4c-.4 0-.8.2-.9.6L.3 11h25.3zM1 19.7V28c0 .6.4 1 1 1h7v-9.3c-1.2.9-2.5 1.3-4 1.3s-2.9-.5-4-1.3m5.3 2.6c.1-.1.2-.2.3-.2.4-.2.8-.1 1.1.3.40.1.1.3.40.2.2.3.1.1.1.120.3.1.4s0 .3-.1.4-.1.2-.2.3-.2.2-.3.2-.3.1-.4.1c-.3 0-.5-.1-.7-.3-.1-.1-.2-.2-.2-.3-.1-.1-.1-.3-.1-.4 0-.3.1-.5.3-.7M24 14c.7 0 1.3.1 2 .2V13H0v1c0 2.8 2.2 5 5 5 1.6 0 3.1-.8 4-2 .9 1.2 2.4 2 4 2 1.2 0 2.2-.4 3.1-1.1 1.8-2.4 4.7-3.9 7.9-3.9M14 24c0-1.1.3.40-2.2.5-3.2-.5.1-1 .2-1.5.2-.7 0-1.4-.1-2-.3V29h4.4c-.9-1.5-1.4-3.2-1.4-5"/>
  ...
  <path fill="#0284c7" d="M3 4h18l-7 8v6l-4 2v-8z"/>
        ...
        add_settings_field(
            ...
            function () {
                if (mulopimfwc_premium_feature()) {
                    ...
                    $message = __("Enable or disable automatic product filter display on shop/archive pages. Use shortcode [mulopimfwc_product_filter] to place it manually.", 'multi-location-product-and-inventory-management');
                    $message .= ' ' . __('Available only when Manual, Inventory-Based, or Proximity-Based assignment is enabled and Optional Location Selection is disabled.', 'multi-location-product-and-inventory-management');
        ...
        add_settings_section(
            ...
            function () {
                ...
                echo '<span class="mulopimfwc-highlight-card-badge">' . esc_html__('Recommended', 'multi-location-product-and-inventory-management') . '</span>';
                echo '<span class="mulopimfwc-highlight-card-title">' . esc_html__('Dynamic AJAX Product Filters for WooCommerce', 'multi-location-product-and-inventory-management') . '</span>';
                echo '</div>';
                echo '</div>';
                echo '<p class="mulopimfwc-highlight-card-text">' . esc_html__('For the best filtering experience, use our Dynamic AJAX Product Filters for WooCommerce. It is fast, works with all themes and builders, and delivers smooth filtering without full page reloads.', 'multi-location-product-and-inventory-management') . '</p>';
                echo '<div class="mulopimfwc-highlight-card-tags">';
                echo '<span class="mulopimfwc-highlight-card-tag">' . esc_html__('Fast', 'multi-location-product-and-inventory-management') . '</span>';
                echo '<span class="mulopimfwc-highlight-card-tag">' . esc_html__('Theme Friendly', 'multi-location-product-and-inventory-management') . '</span>';
                echo '<span class="mulopimfwc-highlight-card-tag">' . esc_html__('Builder Ready', 'multi-location-product-and-inventory-management') . '</span>';
                echo '</div>';
                echo '<a class="mulopimfwc-highlight-card-button" href="' . esc_url($recommendation_url) . '" target="_blank" rel="noopener noreferrer">' . esc_html__('Learn More', 'multi-location-product-and-inventory-management') . '</a>';
                echo '</div>';
            },
            'lwp-product-filter-settings'
        );
    ...
    <g data-name="Health Icons">
      ...
      <path fill="#16a34a" d="M13 27h11v10H13z"/>
        ...
        */
        ...
        add_settings_field(
            'map_animation_type',
            __('Map Animation Type', 'multi-location-product-and-inventory-management'),
            function () {
                global $mulopimfwc_options;
                $options = is_array($mulopimfwc_options ?? null)
                    ? $mulopimfwc_options
            ...
            ?>
                <select name="mulopimfwc_display_options[map_animation_type]">
                    <option value="flyto" <?php selected($value, 'flyto'); ?>><?php echo esc_html_e('Fly To (Smooth Animation)', 'multi-location-product-and-inventory-management'); ?></option>
                    <option value="setview" <?php selected($value, 'setview'); ?>><?php echo esc_html_e('Set View (Animated)', 'multi-location-product-and-inventory-management'); ?></option>
                    <option value="setview_instant" <?php selected($value, 'setview_instant'); ?>><?php echo esc_html_e('Set View (Instant)', 'multi-location-product-and-inventory-management'); ?></option>
                    <option value="none" <?php selected($value, 'none'); ?>><?php echo esc_html_e('No Animation', 'multi-location-product-and-inventory-management'); ?></option>
                </select>
            <?php } else { ?>
                <label class="mulopimfwc_pro_only">
            ...
            <?php } ?>
            <p class="description"><?php echo esc_html_e('Choose how the map animates when switching between locations. Fly To provides smooth camera movement, Set View offers animated transitions, and Instant provides immediate updates.', 'multi-location-product-and-inventory-management'); ?></p>
            <?php
            },
            'lwp-store-locator-settings',
            'mulopimfwc_store_locator_section'
        ...
        add_settings_field(
            ...
            __('Map Animation Duration (seconds)', 'multi-location-product-and-inventory-management'),
            function () {
                global $mulopimfwc_options;
                $options = is_array($mulopimfwc_options ?? null)
                    ? $mulopimfwc_options
            ...
            <?php } ?>
            <p class="description"><?php echo esc_html_e('Duration of the map animation in seconds (0-5). Only applies when animation is enabled.', 'multi-location-product-and-inventory-management'); ?></p>
            <?php
            },
            'lwp-store-locator-settings',
            'mulopimfwc_store_locator_section'
  ...
  <g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/>
        ...
        ?>
            ...
            <p class="description"><?php echo esc_html($this->append_manual_disabled_note(__('Number of days to remember user\'s location choice (1-365).', 'multi-location-product-and-inventory-management'))); ?></p>
        <?php
            },
            'location-advance-settings',
            'mulopimfwc_advanced_settings_section'
        ...
        add_settings_field(
            ...
            __('Cache Cleanup', 'multi-location-product-and-inventory-management'),
            function () {
        ?>
            <button type="button" id="mulopimfwc_clear_cache" class="button button-secondary">
                <span class="dashicons dashicons-update" style="margin-top: 3px;"></span>
                <?php echo esc_html_e('Clear Plugin Cache', 'multi-location-product-and-inventory-management'); ?>
            </button>
            <p class="description"><?php echo esc_html__('Clear cached dashboard metrics, investment/revenue charts, and filter data. Useful after price or stock updates.', 'multi-location-product-and-inventory-management'); ?></p>
...
Product Visibility Rules', 'multi-location-product-and-inventory-management'),
        ...
        add_settings_field(
            ...
            function () {
                ...
                $message = $this->append_manual_disabled_note(__("Show products that are not assigned to any specific location.", 'multi-location-product-and-inventory-management'));
        ...
        add_settings_field(
            ...
            __('Single Product Unavailable Behavior', 'multi-location-product-and-inventory-management'),
            function () {
                global $mulopimfwc_options;
                $options = is_array($mulopimfwc_options ?? null)
                    ? $mulopimfwc_options
...
Out of Stock Product Display', 'multi-location-product-and-inventory-management'),
  ...
  <path fill="#16a34a" d="M216.936 77.105c-.747-.814-1.84-1.224-2.946-1.224h-8.245c-1.105 0-2.198.41-2.946 1.224a3.825 3.825 0 0 0-.504 4.505l4.407 6.644-2.063 17.405 4.063 10.808c.396 1.087 1.933 1.087 2.33 0l4.063-10.808-2.063-17.405 4.407-6.644a3.82 3.82 0 0 0-.503-4.505"/>
        ...
        /* add_settings_field(
            ...
            $options = is_array($mulopimfwc_options ?? null)
                ? $mulopimfwc_options
                : get_option('mulopimfwc_display_options', ['mixed_cart_warning' => __('Your cart contains products from multiple store locations.', 'multi-location-product-and-inventory-management')]);
  ...
  <path fill="#0284c7" d="M7 4h10a2 2 0 0 1 2 2v3h-2V6H7v12h10v-3h2v3a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zm7 6h7v2h-7v-2zm0 4h5v2h-5v-2z"/>
        ...
        add_settings_field(
            ...
            function () {
                ...
                $notes = [
                    'block_checkout' => __('Blocks checkout if any item lacks a valid location. Customers must update the cart or choose a valid location before placing the order.', 'multi-location-product-and-inventory-management'),
                    'unassigned_child' => __('Moves unknown-location items into a separate unassigned child order while other locations are split into their own orders.', 'multi-location-product-and-inventory-management'),
                    'keep_in_parent' => __('Keeps unknown-location items in the parent order while location-assigned items are split into child orders.', 'multi-location-product-and-inventory-management'),
                ];
            ...
            <?php
                if (isset($pickup_settings['enabled']) && $pickup_settings['enabled'] === 'yes') {
                    ...
                    <div style="display: flex; align-items: start; gap: 12px;">
                        ...
                        <div>
                            <p style="margin: 0; color: #856404;">' . esc_html__('Local pickup is not enabled in WooCommerce settings. Please enable it to use this feature.', 'multi-location-product-and-inventory-management') . '</p>
                        </div>
                    </div>
                </div>';
                }
  ...
  <path fill="#16a34a" fill-rule="evenodd" clip-rule="evenodd" d="M4 3a1 1 0 0 0-2 0v17.2A1.8 1.8 0 0 0 3.8 22H21a1 1 0 1 0 0-2H4zm17.707 4.707a1 1 0 0 0-1.414-1.414L14 12.586l-3.293-3.293a1 1 0 0 0-1.414 0l-4 4a1 1 0 1 0 1.414 1.414L10 11.414l3.293 3.293a1 1 0 0 0 1.414 0z" fill="#000"/>
    ...
    private function render_text_management_field(array $field, array $options, bool $is_manual_mode, string $current_template): void
    {
        ...
        if ($type === 'textarea') {
            $rows = $rows > 0 ? $rows : 2;
            echo '<textarea '.(!mulopimfwc_premium_feature() ? 'disabled' : '').' id="' . esc_attr($key) . '" name="mulopimfwc_display_options[' . esc_attr($key) . ']" rows="' . esc_attr($rows) . '"' . $disabled_attr . '>' . esc_textarea($value) . '</textarea>';
        } else {
            echo '<input '.(!mulopimfwc_premium_feature() ? 'disabled' : '').' type="text" id="' . esc_attr($key) . '" name="mulopimfwc_display_options[' . esc_attr($key) . ']" value="' . esc_attr($value) . '" class="regular-text"' . $disabled_attr . '>';
        }
