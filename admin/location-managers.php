...
?>
        <div class="wrap mulopimfwc-location-managers-main">
            ...
            <div class="mlm-settings-icon">
                        <svg class="svg-inline--fa fa-users" aria-hidden="true" data-prefix="fas" data-icon="users" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 16" width="20" height="16"><path fill="#ffffff" d="M4.5 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 1 1 0-5M16 0a2.5 2.5 0 1 1 0 5 2.5 2.5 0 1 1 0-5M0 9.334A3.336 3.336 0 0 1 3.334 6h1.334c.497 0 .969.109 1.394.303A4 4 0 0 0 7.356 10H.666A.67.67 0 0 1 0 9.334M12.666 10h-.022a4 4 0 0 0 1.353-3q-.002-.355-.059-.697A3.3 3.3 0 0 1 15.332 6h1.334A3.335 3.335 0 0 1 20 9.334c0 .369-.3.666-.666.666zM7 7a3 3 0 1 1 6 0 3 3 0 1 1-6 0m-3 8.166C4 12.866 5.866 11 8.166 11h3.669c2.3 0 4.166 1.866 4.166 4.166a.834.834 0 0 1-.834.834H4.834A.834.834 0 0 1 4 15.166"></path></svg>
                    </div>
                ...
                <!-- Add New Manager Button -->
                    <button type="button" class="button button-primary" id="mulopimfwc-add-manager-btn">
                        <svg class="svg-inline--fa fa-plus" aria-hidden="true" data-prefix="fas" data-icon="plus" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32v144H48c-17.7 0-32 14.3-32 32s14.3 32 32 32h144v144c0 17.7 14.3 32 32 32s32-14.3 32-32V288h144c17.7 0 32-14.3 32-32s-14.3-32-32-32H256z"/></svg> <?php echo esc_html__('Add New Location Manager', 'multi-location-product-and-inventory-management'); ?>
                    </button>
                </div>
                            ...
                            <?php foreach ($managers as $manager): ?>
                                ...
                                <div class="mulopimfwc-manager-card" data-manager-id="<?php echo esc_attr($manager->ID); ?>">
                                    ...
                                    <div class="manager-locations">
                                        <h4><svg class="svg-inline--fa fa-location-dot" aria-hidden="true" data-prefix="fas" data-icon="location-dot" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="#9ca3af" d="M215.7 499.2C267 435 384 279.4 384 192 384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2 12.3 15.3 35.1 15.3 47.4 0M192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128"/></svg><?php echo esc_html__('Assigned Locations:', 'multi-location-product-and-inventory-management'); ?></h4>
                                    ...
                                    <div class="manager-capabilities">
                                        <h4><svg class="svg-inline--fa fa-key" aria-hidden="true" data-prefix="fas" data-icon="key" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#9ca3af" d="M336 352c97.2 0 176-78.8 176-176S433.2 0 336 0 160 78.8 160 176c0 18.7 2.9 36.8 8.3 53.7L7 391c-4.5 4.5-7 10.6-7 17v80c0 13.3 10.7 24 24 24h80c13.3 0 24-10.7 24-24v-40h40c13.3 0 24-10.7 24-24v-40h40c6.4 0 12.5-2.5 17-7l33.3-33.3c16.9 5.4 35 8.3 53.7 8.3m40-256a40 40 0 1 1 0 80 40 40 0 1 1 0-80"/></svg><?php echo esc_html__('Permissions:', 'multi-location-product-and-inventory-management'); ?></h4>
...
.manager-actions .mulopimfwc-edit-manager {
    background: #2563eb !important;
    border-color: #2563eb !important;
...
.manager-actions button svg {
    ...
    align-items: center;
            ...
            .manager-locations h4 svg, .manager-capabilities h4 svg{
    width: auto;
    height: 14px;
    margin-right: 6px;
}
