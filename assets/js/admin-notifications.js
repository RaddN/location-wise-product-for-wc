(function ($) {
    ...
    function injectStyles() {
        const allowedStyles = ['modern', 'minimal', 'classic'];
        const style = allowedStyles.includes(config.notification_style) ? config.notification_style : 'modern';

        floatContainer
            .removeClass('mulopimfwc-notification-style-modern mulopimfwc-notification-style-minimal mulopimfwc-notification-style-classic')
            .addClass('mulopimfwc-notification-style-' + style);
    }
    ...
    function initAdminBarNotifications() {
        // Admin bar notification styles are loaded from the enqueued CSS file.
    }
