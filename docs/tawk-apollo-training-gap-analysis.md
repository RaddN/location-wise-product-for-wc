...
| Shortcodes catalog | Public docs cover some display shortcodes, but Apollo needs one complete shortcode reference including `mulopimfwc_store_location_selector`, `mulopimfwc_display_popup`, `mulopimfwc_location_archive`, `mulopimfwc_location_products`, `mulopimfwc_location_info`, `mulopimfwc_location_recommendations`, `mulopimfwc_product_filter`, and `mulopimfwc_location_status`. | `multi-location-product-and-inventory-management-pro.php:3400-3401`, `includes/frontend-location-information.php:151-153`, `includes/customer-location-insights.php:96`, `includes/frontend-product-filter.php:45`, `admin/admin.php:95` |
